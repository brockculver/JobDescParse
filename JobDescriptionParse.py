...
class JDparser:
    ...
    def get_attributes(self):
        ...
        skills=self.getCommonWords(self.jobDesc)
        return["Attributes Detected of the Job Description: Education: ", education, " Major: ", major," 5 Most Common Words in Job Description", skills]
